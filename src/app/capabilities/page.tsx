...
const castingApplications: InfoCard[] = [
  ...
  },
  {
    ...
    description:
      "Appearance-focused covers, including decorative non-load-bearing brake caliper covers, produced as compact aluminum exterior parts only.",
  },
  {
...
const machiningSupport: InfoCard[] = [
  ...
  {
    title: "Deburring and Part Preparation",
    description:
          ...
          <div className="container-shell grid gap-12 py-16 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:py-24">
            <div className="motion-rise">
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-[#c7beaf]">
                ...
                non-load-bearing brake caliper covers, and OEM aluminum parts
